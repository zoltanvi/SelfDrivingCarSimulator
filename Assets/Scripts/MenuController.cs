...
public class MenuController : MonoBehaviour
{
	...
	{
		// Ha rossz inputot kap seedként, beállít helyette egy randomot.
		try
		{
			RandomHelper.Seed = int.Parse(seedInputField.text);
		}
	...
	{
		seedInputField.text = text;
	}

	public void UpdateSeedInputText()
	{
		seedInputField.text = RandomHelper.Seed.ToString();
	}
